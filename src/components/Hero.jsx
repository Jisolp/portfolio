...
const Hero = () => (
  <section id="home" className="relative w-full h-screen">
    ...
    <div className={`absolute top-1/3 left-0 right-0 text-center z-30`}>
      ...
      <p className="font-mono text-[17px] xs:text-[22px] text-black xs:leading-[30px] leading-[30px] w-full">I am a software engineer, and I love <a href="./Exploring" className="underline hover:opacity-30">exploring</a> and <a href= "./Projects" className="underline hover:opacity-30">building</a></p>
